...
- 页面只调用 `PUT /api/admin/workflow-templates/packages/{id}/node-graph` 保存 `nodeGraph`，不提交节点定义字段。
...
4. /Users/kevin/workspace/micro-office/micro-office/docs/versions/V1.1.13/backend.md
...
- 节点设计接口只操作节点定义。
- 工作流模板接口不再保存节点定义字段。
- 工作流保存只认 `PUT /api/admin/workflow-templates/packages/{id}/node-graph`。
...
3. /Users/kevin/workspace/micro-office/micro-office/docs/versions/V1.1.13/overview.md
4. /Users/kevin/workspace/micro-office/micro-office/docs/versions/V1.1.13/database.md

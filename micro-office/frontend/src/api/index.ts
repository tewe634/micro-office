...
export const objectApi = {
  list: (type?: string, deptId?: string, name?: string, customerRole?: string, customerScale?: string, parentObjectId?: string, customerHealth?: string) => api.get('/objects', { params: { type, deptId, name, customerRole, customerScale, parentObjectId, customerHealth } }),
  page: (params?: { current?: number; size?: number; type?: string; deptId?: string; orgId?: string; name?: string; customerRole?: string; customerScale?: string; parentObjectId?: string; customerHealth?: string }) => api.get('/objects/page', { params }),
